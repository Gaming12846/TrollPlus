...
public class TrollCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        VMConstants.TROLL_MENU.setItem(51, ItemBuilder.createItemWithLore(Material.CHEST, 1, ChatColor.WHITE + "Invsee", Collections.singletonList("Open the target inventory")));
        VMConstants.TROLL_MENU.setItem(50, ItemBuilder.createItemWithLore(Material.WITHER_SKELETON_SKULL, 1, ChatColor.WHITE + "Kill", Collections.singletonList("Kill the target")));
        ...
        //VMConstants.TROLL_MENU.setItem(11, ItemBuilder.createItemWithLore(Material.ICE, 1, ChatColor.WHITE + "Inventory drop", Collections.singletonList("Drop all items in the inventory from the target")));
