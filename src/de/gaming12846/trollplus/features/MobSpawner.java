...
public class MobSpawner {
	...
	public static void mobSpawner(Player victim) {
		new BukkitRunnable() {

			@Override
			public void run() {

				if (Vars.Lists.mobSpawnerList.contains(victim.getName())) {
					...
					victim.getWorld().spawnEntity(victim.getLocation(), entitys.get(RandomUtils.JVM_RANDOM.nextInt(entitys.size())));
				} else
					cancel();
			}
